export const laravelEventsListenersLesson = {
  id: 'laravel-events-listeners',
  title: 'Events & Listeners: Decoupling, Domain Events, Async Listeners',
  titleFa: 'Event و Listener: جداسازی، Domain Event، اجرای async',
  difficulty: 'hard',
  estimatedTime: '293 min',

  content: `
# Events & Listeners

Events help you decouple your application.

Example:
- When a user registers, you may:
  - send email
  - create profile
  - notify admins

Instead of doing everything in one method, you emit an event and listeners react.
...
export default laravelEventsListenersLesson;

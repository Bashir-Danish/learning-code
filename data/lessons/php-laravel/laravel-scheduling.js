export const laravelSchedulingLesson = {
  id: 'laravel-scheduling',
  title: 'Task Scheduling: Cron + Laravel Scheduler + Production Patterns',
  titleFa: 'زمان‌بندی وظایف: Cron + Scheduler لاراول + الگوهای production',
  difficulty: 'hard',
...
Laravel provides a scheduler so you define scheduled tasks in code.
...
export default laravelSchedulingLesson;

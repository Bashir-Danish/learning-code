export const laravelEloquentRelationshipsLesson = {
  id: 'laravel-eloquent-relationships',
  title: 'Eloquent Relationships: One-to-Many, Many-to-Many, Polymorphic',
  titleFa: 'روابط Eloquent: یک‌به‌چند، چند‌به‌چند، Polymorphic',
  difficulty: 'hard',
...
Relationships are the core of most Laravel apps.
...
export default laravelEloquentRelationshipsLesson;

export const laravelAuthorizationPoliciesGatesLesson = {
  id: 'laravel-authorization-policies-gates',
  title: 'Authorization: Gates, Policies, and Role/Permission Patterns',
  titleFa: 'مجوزدهی: Gate، Policy و الگوهای نقش/دسترسی',
  difficulty: 'hard',
  estimatedTime: '315 min',

  content: `
# Authorization: Gates, Policies, and Role/Permission Patterns

Authorization answers: **“Is this user allowed to do this?”**

In real APIs, authorization is where many security bugs happen:
- a route is protected with authentication
- but anyone logged in can access **any record**, not just their own

Laravel gives you a clean, testable authorization system:
- **Gates**: simple / action-level checks (often not tied to one model)
- **Policies**: resource-based authorization (recommended for CRUD)
...
export default laravelAuthorizationPoliciesGatesLesson;

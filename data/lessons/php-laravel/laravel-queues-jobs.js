export const laravelQueuesJobsLesson = {
  id: 'laravel-queues-jobs',
  title: 'Queues & Jobs: Async Work, Retries, Failed Jobs, Idempotency',
  titleFa: 'صف و Job: کارهای async، retry، failed job، idempotency',
  difficulty: 'hard',
  estimatedTime: '338 min',

  content: `
# Queues & Jobs

Queues let you move slow work out of the request:
- sending email
- processing files
...
export default laravelQueuesJobsLesson;

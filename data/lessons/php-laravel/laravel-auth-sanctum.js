export const laravelAuthSanctumLesson = {
  id: 'laravel-auth-sanctum',
  title: 'Auth for APIs: Laravel Sanctum (Tokens, SPA Patterns)',
  titleFa: 'احراز هویت برای API: Laravel Sanctum (توکن، الگوی SPA)',
  difficulty: 'hard',
  estimatedTime: '315 min',

  content: `
# Auth for APIs: Laravel Sanctum
...
export default laravelAuthSanctumLesson;

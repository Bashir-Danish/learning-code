export const laravelSecurityHardeningLesson = {
  id: 'laravel-security-hardening',
  title: 'Security Hardening: CSRF/CORS, Encryption, Uploads, Rate Limiting',
  titleFa: 'سخت‌سازی امنیت: CSRF/CORS، رمزنگاری، آپلود، Rate Limiting',
  difficulty: 'hard',
  estimatedTime: '360 min',

  content: `
# Security Hardening in Laravel

Laravel is secure by default in many areas, but production security still needs deliberate design.

This lesson focuses on the things that actually break in real projects:
- API auth misconfig (cookie vs token)
- unsafe file uploads
- missing throttling
...
export default laravelSecurityHardeningLesson;

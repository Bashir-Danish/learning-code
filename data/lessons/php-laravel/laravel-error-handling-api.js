export const laravelErrorHandlingApiLesson = {
  id: 'laravel-error-handling-api',
  title: 'API Error Handling: Exceptions, Validation Errors, Not Found',
  titleFa: 'مدیریت خطا در API: Exception، خطای اعتبارسنجی، Not Found',
  difficulty: 'hard',
  estimatedTime: '215 min',

  content: `
# API Error Handling in Laravel

Your API should return **consistent error shapes**.
...
export default laravelErrorHandlingApiLesson;

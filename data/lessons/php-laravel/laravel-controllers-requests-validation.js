export const laravelControllersRequestsValidationLesson = {
  id: 'laravel-controllers-requests-validation',
  title: 'Controllers + Requests + Validation (FormRequest) for APIs',
  titleFa: 'کنترلر + Request + اعتبارسنجی (FormRequest) برای API',
  difficulty: 'hard',
  estimatedTime: '270 min',

  content: `
# Controllers + Requests + Validation (FormRequest) for APIs

In Laravel APIs, validation should happen at the boundary.
...
- \`app/Http/Controllers/\`: All controller classes
- \`app/Http/Controllers/Api/\`: API-specific controllers (return JSON)
- \`app/Http/Controllers/Web/\`: Web controllers (return views)
...
export default laravelControllersRequestsValidationLesson;

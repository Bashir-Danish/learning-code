export const laravelProjectStructureLifecycleLesson = {
  id: 'laravel-project-structure-lifecycle',
  title: 'Laravel Core: Project Structure + Request Lifecycle + Service Container',
  titleFa: 'هسته لاراول: ساختار پروژه + چرخه درخواست + Service Container',
  difficulty: 'hard',
  estimatedTime: '215 min',

  content: `
# Laravel Core: Project Structure + Request Lifecycle + Service Container
...
export default laravelProjectStructureLifecycleLesson;
